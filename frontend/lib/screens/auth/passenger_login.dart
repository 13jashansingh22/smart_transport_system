...
class _PassengerLoginScreenState extends State<PassengerLoginScreen> {
  ...
  List<Widget> _selectedItems(List<String> values) {
    return values
        .map(
          (value) => Align(
  ...
  Future<void> _submit() async {
    ...
    try {
      if (isSignupMode) {
        await BackendService.instance.createPassengerAccount(
        ...
        await BackendService.instance.signInAndSyncProfile(
          role: 'passenger',
          email: normalizedEmail,
          password: normalizedPassword,
          state: _selectedState!,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            isExpanded: true,
                            selectedItemBuilder: (_) => _selectedItems(_states),
                            decoration: const InputDecoration(
                              labelText: 'State',
                            ),
                            items: _dropdownItems(_states),
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            isExpanded: true,
                            selectedItemBuilder: (_) => _selectedItems(_cities),
                            decoration: const InputDecoration(
                              labelText: 'City',
                            ),
                            items: _dropdownItems(_cities),
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            isExpanded: true,
                            selectedItemBuilder: (_) => _selectedItems(_towns),
                            decoration: const InputDecoration(
                              labelText: 'Town / Area',
                            ),
                            items: _dropdownItems(_towns),
                            onChanged: loading
                                ? null
                                : (value) =>
